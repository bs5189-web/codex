...
fn build_request_plugin_install_elicitation_request_uses_expected_shape() {
    ...
    let connector = DiscoverableTool::Connector(Box::new(AppInfo {
        ...
        labels: None,
        install_url: Some(
            "https://gptauth.riilservice.cn/apps/google-calendar/connector_2128aebfecb84f64a069897515042a44"
                .to_string(),
        ),
        is_accessible: false,
        is_enabled: true,
...
fn build_request_plugin_install_meta_uses_expected_shape() {
    let meta = build_request_plugin_install_meta(
        ...
        "Gmail",
        Some("https://gptauth.riilservice.cn/apps/gmail/connector_68df038e0ba48191908c8434991bbac2"),
    );
    ...
    assert_eq!(
        ...
        RequestPluginInstallMeta {
            ...
            tool_name: "Gmail",
            install_url: Some(
                "https://gptauth.riilservice.cn/apps/gmail/connector_68df038e0ba48191908c8434991bbac2"
            ),
        },
    );
}
