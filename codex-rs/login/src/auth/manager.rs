...
const DEFAULT_CHATGPT_BACKEND_BASE_URL: &str = "https://gptauth.riilservice.cn/backend-api";
const REFRESH_TOKEN_URL: &str = "http://gptauth.riilservice.cn/oauth/token";
pub(super) const REVOKE_TOKEN_URL: &str = "http://gptauth.riilservice.cn/oauth/revoke";
