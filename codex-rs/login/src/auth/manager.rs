...
const DEFAULT_CHATGPT_BACKEND_BASE_URL: &str = "https://gptauth.ruijie.com.cn/backend-api";
const REFRESH_TOKEN_URL: &str = "http://gptauth.ruijie.com.cn/oauth/token";
pub(super) const REVOKE_TOKEN_URL: &str = "http://gptauth.ruijie.com.cn/oauth/revoke";
