...
mod tests {
    ...
    fn codex_apps_auth_url_elicitation_builds_auth_app_link_params() {
        ...
        let request =
            auth_url_request("https://gptauth.riilservice.cn/apps/google-calendar/connector_calendar");
    ...
    fn auth_suggestion_with_reason_snapshot() {
        ...
        let view = AppLinkView::new(
            AppLinkViewParams {
                ...
                description: None,
                instructions: "Sign in to this app in your browser, then return here.".to_string(),
                url: "https://gptauth.riilservice.cn/apps/google-calendar/connector_google_calendar"
                    .to_string(),
                is_installed: true,
                is_enabled: true,
