...
const APP_TOOLTIP: &str = "Try the **Codex App**. Run 'codex app' or visit https://gptauth.riilservice.cn/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **Codex App**. Run 'codex app' or visit https://gptauth.riilservice.cn/codex?app-landing-page=true";
