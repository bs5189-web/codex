...
const AGENT_IDENTITY_JWT_ISSUER: &str = "https://gptauth.riilservice.cn/codex-backend/agent-identity";
...
-----END PRIVATE KEY-----"#,
    ...
    fn agent_identity_jwks_url_uses_backend_api_base_url() {
        assert_eq!(
            agent_identity_jwks_url("https://gptauth.riilservice.cn/backend-api"),
            "https://gptauth.riilservice.cn/backend-api/wham/agent-identities/jwks"
        );
        assert_eq!(
            agent_identity_jwks_url("https://gptauth.riilservice.cn/backend-api/"),
            "https://gptauth.riilservice.cn/backend-api/wham/agent-identities/jwks"
