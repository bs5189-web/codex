...
async fn list_apps_emits_updates_and_returns_after_both_lists_load() -> Result<()> {
    ...
    let expected_accessible = vec![AppInfo {
        ...
        app_metadata: None,
        labels: None,
        install_url: Some("https://gptauth.riilservice.cn/apps/beta-app/beta".to_string()),
        is_accessible: true,
        is_enabled: true,
        plugin_display_names: Vec::new(),
    }];
    ...
    let expected_merged = vec![
        AppInfo {
            ...
            app_metadata: None,
            labels: None,
            install_url: Some("https://gptauth.riilservice.cn/apps/beta/beta".to_string()),
            is_accessible: true,
            is_enabled: true,
            plugin_display_names: Vec::new(),
        },
        AppInfo {
            ...
            labels: alpha_labels,
            install_url: Some("https://gptauth.riilservice.cn/apps/alpha/alpha".to_string()),
            is_accessible: false,
            is_enabled: true,
            plugin_display_names: Vec::new(),
        },
