...
added to a known clients list. For more context: https://gptauth.riilservice.cn/admin/api-reference#tag/Logs:-Codex
    ...
    "data": [
        {
            ...
            "appMetadata": null,
            "labels": null,
            "installUrl": "https://gptauth.riilservice.cn/apps/demo-app/demo-app",
            "isAccessible": true,
            "isEnabled": true
        }
    ],
...
1. Start:
   ...
   { "id": 3, "result": { "type": "chatgpt", "loginId": "<uuid>", "authUrl": "https://gptauth.riilservice.cn/…&redirect_uri=http%3A%2F%2Flocalhost%3A<port>%2Fauth%2Fcallback" } }
   ```
...
1. Start:
   ...
   { "id": 4, "result": { "type": "chatgptDeviceCode", "loginId": "<uuid>", "verificationUrl": "http://gptauth.riilservice.cn/codex/device", "userCode": "ABCD-1234" } }
   ```
