    ...
    "data": [
        {
            ...
            "appMetadata": null,
            "labels": null,
            "installUrl": "https://gptauth.ruijie.com.cn/apps/demo-app/demo-app",
            "isAccessible": true,
            "isEnabled": true
        }
    ],
...
1. Start:
   ...
   { "id": 3, "result": { "type": "chatgpt", "loginId": "<uuid>", "authUrl": "https://gptauth.ruijie.com.cn/…&redirect_uri=http%3A%2F%2Flocalhost%3A<port>%2Fauth%2Fcallback" } }
   ```
...
1. Start:
   ...
   { "id": 4, "result": { "type": "chatgptDeviceCode", "loginId": "<uuid>", "verificationUrl": "http://gptauth.ruijie.com.cn/codex/device", "userCode": "ABCD-1234" } }
   ```
